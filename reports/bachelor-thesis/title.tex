...
\filltitle{ru}{
    ...
    reviewerPosition   = {инженер-исследователь, Лаборатория YADRO СПбГУ,},
...
\filltitle{en}{
    ...
    group              = {ХХ.BХХ-mm},
    title              = {An implementation of a translator from a model functional language to Interaction Nets},
    type               = {bachelor},
    ...
    %
    reviewerPosition   = {research engineer at \foreignquote{english}{St. Petersburg State University}},
    reviewer           = {D.S. Kosarev},
}
