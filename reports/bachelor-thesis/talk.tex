...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \item Попытки расширить схему предпринимались, но не подходят в нашем случае
...
\begin{frame}
    ...
    \begin{itemize}
        \item На данном этапе проводить сравнительные эксперименты невозможно, но попытаться оценить возможности инструмента можно
        \item Можно исследовать параллельность
        \item Параллельность уровня \INs{}:
              \begin{itemize}
                  \item Малый шаг~--- редукция одной активной пары
                  \item Большой шаг~--- редукция всех доступных активных пар
              \end{itemize}
        \item Параллельность уровня стратегии вычисления:
              \begin{itemize}
                  \item Последовательная схема~--- аргументы применения вычисляются по очереди
                  \item Последовательная схема~--- аргументы вычисляются одновременно
              \end{itemize}
    \end{itemize}
...
\begin{frame}
    \frametitle{Параллельность уровня стратегии вычислений???}

    \begin{columns}
        \begin{column}{0.45\linewidth}
            \begin{figure}
                \begin{center}
                    \includegraphics[width=\linewidth, page=1]{figures/Figures_cropped.pdf}
                \end{center}
...
\begin{frame}
    ...
    \begin{figure}
        \begin{center}
            \includegraphics[width=0.65\linewidth, page=3]{figures/Figures_cropped.pdf}
        \end{center}
    \end{figure}
