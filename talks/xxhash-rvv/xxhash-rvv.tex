...
\begin{frame}
    ...
    \end{itemize}
    % Первая плата с C908 имеет очень странную топологию CPU.

    % Дождались BPI-F3.

    % Версия вдохновленная SVE заработала отлично!

    % (А ещё в GCC завезли поддержку XTheadVector, но кажется, там бага)
